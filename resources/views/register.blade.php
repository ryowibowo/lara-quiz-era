        ...
        <div class="card my-5">
          <div class="card-body">
            ...
            <form action="/register" method="POST">
                ...
                <div class="form-group mb-3">
                    <input type="text" class="form-control" name="phone_number" placeholder="No. Handphone" value="{{ old('phone_number') }}">
                </div>
                @error('phone_number')
                    <div style="color: #f32f53; margin-bottom:15px;">
                        {{ $message }}
                ...
                <div class="form-group mb-3">
                    <select class="form-select" name="role_id" required>
                        <option value="b319dbc4-5b29-4eef-9ec9-f83d8cb909a3" {{ old('role_id') == 'b319dbc4-5b29-4eef-9ec9-f83d8cb909a3' ? 'selected' : '' }}>User</option>
                        <option value="bf7e9198-d190-470c-ae41-4b9b1d6c2a74" {{ old('role_id') == 'bf7e9198-d190-470c-ae41-4b9b1d6c2a74' ? 'selected' : '' }}>Admin</option>
                    </select>
                </div>
                @error('role_id')
                    <div style="color: #f32f53; margin-bottom:15px;">
            ...
            <div class="d-flex justify-content-between align-items-end mt-4">
              <h6 class="f-w-500 mb-0">Sudah ada Akun?</h6>
